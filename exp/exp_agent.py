        ...
        if self.args.individual:
            ...
            for c in range(num_channels):
                ...
                if self.args.task == 'TSF':
                    channel_output = self.model.forward(x=channel_x, timestamp_x=timestamp_x)  # channel_output: [batch_size, output_len, 1]
            ...
            if self.args.task == 'TSF':
                final_output = self.model.forward(x=batch_x, timestamp_x=timestamp_x)
            elif self.args.task == 'TGTSF':
