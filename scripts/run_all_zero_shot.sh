bash scripts/NYC_traffic_speed/dlinear_zero_shot.sh
bash scripts/NYC_traffic_speed/FITS_zero_shot.sh
bash scripts/NYC_traffic_speed/itrans_zero_shot.sh
bash scripts/NYC_traffic_speed/patchTST_zero_shot.sh
bash scripts/NYC_traffic_speed/TGTSF_zero_shot.sh
...
bash scripts/Bear_room/itrans_zero_shot.sh
bash scripts/Bear_room/patchTST_zero_shot.sh
bash scripts/Bear_room/TGTSF_zero_shot.sh
